    ...
    <nav className="navigation-bar">
      <div className="nav-container">
        <ul className="left-container">
          ...
          <li className="list-item">
            <Link className="nav-link" to="/study-material">
              Study Materials
            </Link>
          </li>
          <li className="list-item scholarship">
            <Link className="nav-link" to="/scholarships">
              Scholarships
            </Link>
            <span className="new-word">NEW</span>
          </li>
          <li className="list-item">
            <Link className="nav-link" to="/allen-e-store">
              ALLEN E-Store
            </Link>
          </li>
          <li className="list-item">
        ...
        <ul className="right-container">
          <li className="right-list-item call">
            <button>
              <span className="material-symbols-outlined">call</span>
            </button>
          </li>
          <li className="right-list-item login">
            <button>Login</button>
          </li>
        </ul>
      </div>
